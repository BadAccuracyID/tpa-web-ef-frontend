import {Audience, Group, User} from "../../lib/gql/graphql.ts";
...
import {createGroupPost} from "../../lib/controllers/group-controller.ts";

export function CreatePostComponent({user, onClose}: { user: User, onClose: () => void }) {
...
export function CreateGroupPostComponent({user, group, onClose}: { user: User, group: Group, onClose: () => void }) {
    const profilePicture = user.profilePicture;
            ...
            <div className="create-post-popup-container">
                ...
                <div className="create-post-popup-container-user">
                    ...
                    <div className="create-post-popup-container-user-sub-info">
                        ...
                        <div className="create-post-popup-container-user-sub-info-group">
                            Group: {group.name}
                        </div>
                    </div>
                </div>
